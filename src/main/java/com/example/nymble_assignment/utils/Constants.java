...
public class Constants {
    ...
    public static int destination1Id = 1002;
    public static  String destination1Name = "Lucknow";
    
    public static int destination2Id = 1003;
    public static  String destination2Name = "Delhi";
